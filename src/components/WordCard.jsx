...
export default function WordCard({ word, onDelete, onEdit }) {
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {confirming ? (
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              onClick={() => onEdit(word)}
              className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition cursor-pointer"
            ...
            <button
              ...
              className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition cursor-pointer"
